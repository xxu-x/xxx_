...
sylar::ConfigVar<float>::ptr g_float_value_config = 
    sylar::Config::Lookup("system.value", (float)10.1999998, "system value");
...
sylar::ConfigVar<std::unordered_set<int>>::ptr g_int_uset_value_config = 
    sylar::Config::Lookup("system.int_uset", std::unordered_set<int>{1,2,3}, "system int uset");
...
sylar::ConfigVar<std::unordered_map<std::string, int>>::ptr g_str_int_umap_value_config = 
    sylar::Config::Lookup("system.str_int_umap", std::unordered_map<std::string, int>{{"k", 5}}, "system str int umap");
...
void test_yaml(){
    YAML::Node root = YAML::LoadFile("/mnt/e/sylar_Project/bin/conf/test.yml");
...
void test_log(){
    ...
    YAML::Node root = YAML::LoadFile("/mnt/e/sylar_Project/bin/conf/log.yml");
    sylar::Config::LoadFromYaml(root);

...
public:
    ...
    typedef std::function<void (const T& old_val, const T& new_value)> on_change_cb;//用于配置修改
...
private:
    ...
    //这个类会创建一个全局变量的配置，如果使用静态成员，如果比这个全局变量晚就会出现内存错误，使用静态方法，
    /**
     * @brief 配置项的RWMutex
     */

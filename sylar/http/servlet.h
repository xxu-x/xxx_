...
public:
    ...
    void addServletCreator(const std::string& uri, Servlet::ptr creator);
    void addGlobServletCreator(const std::string& uri, Servlet::ptr creator);
    ...
    void listAllServletCreator(std::map<std::string, Servlet::ptr>& infos);
    void listAllGlobServletCreator(std::map<std::string, Servlet::ptr>& infos);
private:
    /// 读写互斥量
    RWMutexType m_mutex;
    /// 精准匹配servlet MAP

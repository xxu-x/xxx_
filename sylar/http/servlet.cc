...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet(m_name));
}
...
// void ServletDispatch::addServletCreator(const std::string& uri, Servlet::ptr creator){

// }

// void ServletDispatch::addGlobServletCreator(const std::string& uri, Servlet::ptr creator){
